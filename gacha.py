...
def loadBaileys():
    ...
    baileys.append(Unit("Two Chair Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446898198089799/IMG_8530.jpg",LEGENDARY,Element.GRUMPY))
    baileys.append(Unit("Grabbed Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446898428772442/IMG_8529.jpg",RARE,Element.GRUMPY))
    baileys.append(Unit("Mighty Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446898672050176/IMG_8528.jpg",LEGENDARY,Element.SILLY))
    baileys.append(Unit("Close up bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070447034261319792/IMG_8492.jpg",RARE,Element.GRUMPY))
    baileys.append(Unit("Stretching Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446910881669250/IMG_8527.jpg",COMMON,Element.GRUMPY))
    baileys.append(Unit("POV Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446911078805606/IMG_8526.jpg",COMMON,Element.SILLY))
    baileys.append(Unit("Devious Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446911296897155/IMG_8525.jpg",COMMON,Element.GRUMPY))
    baileys.append(Unit("At peace Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446922164338718/IMG_8524.jpg",RARE,Element.SLEEPY))
    baileys.append(Unit("Pride Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446922344714413/IMG_8523.jpg",RARE,Element.SILLY))
    baileys.append(Unit("One-eyed Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070447034013847572/IMG_8493.jpg",COMMON,Element.SILLY))
    baileys.append(Unit("Snoozing bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070447033665728522/IMG_8494.jpg",COMMON,Element.SLEEPY))
    baileys.append(Unit("Pride Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446922344714413/IMG_8523.jpg",RARE,Element.SILLY))
    baileys.append(Unit("Rear Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446928904585248/IMG_8522.jpg",EPIC,Element.GRUMPY))
    baileys.append(Unit("King Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446938836709406/IMG_8521.jpg",MYTHICAL,Element.GRUMPY))
    baileys.append(Unit("Upside Down Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446939088355458/IMG_8520.jpg",RARE,Element.SILLY))
    baileys.append(Unit("Sun Lounge Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446939293896795/IMG_8519.jpg",COMMON,Element.SLEEPY))
    baileys.append(Unit("Sunglasses Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446949259554856/IMG_8518.jpg",LEGENDARY,Element.SILLY))
    baileys.append(Unit("Warm Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446949481844848/IMG_8517.jpg",COMMON,Element.SILLY))
    baileys.append(Unit("Mummified Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446949670600795/IMG_8516.jpg",LEGENDARY,Element.GRUMPY))
    baileys.append(Unit("Spinning Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446959996969010/IMG_8515.jpg",COMMON,Element.SILLY))
    baileys.append(Unit("Tennis Ball Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446960215076874/IMG_8514.jpg",COMMON,Element.GRUMPY))
    baileys.append(Unit("Action-Shot Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446960466739270/IMG_8513.jpg",RARE,Element.SILLY))
    baileys.append(Unit("Pride Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446922344714413/IMG_8523.jpg",COMMON,Element.SILLY))

    baileys.append(Unit("Birthday Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446995262672997/IMG_8506.jpg",MYTHICAL,Element.SILLY))
    baileys.append(Unit("Horrors Beyond Human Comprehension Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070453313428013147/image.png",LEGENDARY,Element.GRUMPY))


    baileys.append(Unit("Displeased bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070447023947522078/IMG_8495.jpg",RARE,Element.GRUMPY))
    baileys.append(Unit("Balancing bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070447023750393876/IMG_8496.jpg",RARE,Element.SILLY))
    baileys.append(Unit("Void eyes bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070447014418075748/IMG_8498.jpg",COMMON,Element.GRUMPY))
    baileys.append(Unit("Jailed bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070447014195773530/IMG_8499.jpg",EPIC,Element.GRUMPY))
    baileys.append(Unit("Shaking bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070447003978436779/IMG_8501.jpg",RARE,Element.SILLY))
    baileys.append(Unit("ZZZzzzZZzzZzzZZ bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070447003726782564/IMG_8502.jpg",COMMON,Element.SLEEPY))
    baileys.append(Unit("licking bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070447003475120188/IMG_8503.jpg",RARE,Element.GRUMPY))
    baileys.append(Unit("Smirking Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446995795349655/IMG_8504.jpg",EPIC,Element.SILLY))
    baileys.append(Unit("Dish washing Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446995539505192/IMG_8505.jpg",LEGENDARY,Element.SILLY))
    baileys.append(Unit("Judgemental Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446984521072650/IMG_8508.jpg",COMMON,Element.GRUMPY))
    baileys.append(Unit("Christmas Cracker Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446984139386971/IMG_8509.jpg",EPIC,Element.SILLY))
    baileys.append(Unit("Patient Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446970474352690/IMG_8510.jpg",RARE,Element.GRUMPY))
    baileys.append(Unit("Waiting Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446970243662086/IMG_8511.jpg",COMMON,Element.GRUMPY))
    baileys.append(Unit("Pillow Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1070446970046517308/IMG_8512.jpg",LEGENDARY,Element.SLEEPY))
    baileys.append(Unit("Cone Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1072660623311261757/image.png",LEGENDARY,Element.GRUMPY))
    baileys.append(Unit("Confusing Perspective Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1072884948320653382/IMG_8630.jpg",RARE,Element.SILLY))
    baileys.append(Unit("Pillow Tower Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1072885273186275418/IMG_8658.jpg",COMMON,Element.SILLY))
    baileys.append(Unit("Alcoholic Bailey","https://cdn.discordapp.com/attachments/1039213143903182939/1072885680776151110/IMG_8659.jpg",EPIC,Element.GRUMPY))
